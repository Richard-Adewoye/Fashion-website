...
export const ProductGrid: React.FC<ProductGridProps> = ({
  ...
  const availableColors = ['Noir', 'Camel', 'Ecru', 'Oatmeal', 'Charcoal', 'Cognac', 'Olive', 'Navy'];
  ...
  return (
    <section id="catalog-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {isFilterPanelOpen && (
        <div id="filter-drawer-panel" className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 mb-8 grid grid-cols-1 md:grid-cols-4 gap-6 transition-all">
          {/* Price Range Filter */}
          ...
          {/* Colors Filter */}
          <div className="space-y-2">
            <h4 className="text-xs font-mono uppercase text-amber-300 tracking-wider">Color Palette</h4>
            <div className="flex flex-wrap gap-2">
              {availableColors.map((col) => {
                const isSelected = filterState.colors.includes(col);
                return (
                  <button
                    key={col}
                    onClick={() => {
          ...
          {/* Sizes Filter */}
          <div className="space-y-2">
            <h4 className="text-xs font-mono uppercase text-amber-300 tracking-wider">Sizes</h4>
            <div className="flex flex-wrap gap-2">
